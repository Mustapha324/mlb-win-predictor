          ...
          <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {games.map((game) => (
              <GameCard
                ...
                awayWinPct={Math.round(game.away_win_probability * 100)}
                homeWinPct={Math.round(game.home_win_probability * 100)}
                gameTime={game.game_time_utc ?? toGameTimeLabel(dateLabel)}
